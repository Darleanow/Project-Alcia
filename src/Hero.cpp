...
void Hero::delete_an_item ()
{
  ...
  while (delete_choice < "1" || static_cast<size_t> (delete_choice[0] - 49) >=
                                    this->inventory.size ()) {
    this->show_inventory ();
  ...
  for (size_t items = 0; items < this->inventory.size (); items++) {
    std::cout << items + 1 << ". "
              << color (get_color_from_string (get_color_from_rarity (
                     this->inventory[items]->get_rarity ()
                 )))
              << this->inventory[items]->get_name ()
    ...
    std::cout
        << (this->helmet.empty ()
                ...
                : "Helmet: " +
                      ...
                      color (ColorType::DEFAULT) + " || Bonus: " +
                      std::to_string (this->helmet.back ()->get_hp ()) + " hp")
        << std::endl;
    ...
    std::cout
        << (this->pants.empty ()
                ...
                : "Pants: " +
                      ...
                      color (ColorType::DEFAULT) + " || Bonus: " +
                      std::to_string (this->pants.back ()->get_hp ()) + " hp")
        << std::endl;
    ...
    std::cout
        << (this->boots.empty ()
                ...
                : "Boots: " +
                      ...
                      color (ColorType::DEFAULT) + " || Bonus: " +
                      std::to_string (this->boots.back ()->get_hp ()) + " hp")
        << std::endl
        << std::endl;
  ...
  if (sel_choice == "1") {
    ...
    while (choice != "1" && choice != "2" && choice != "3" && choice != "4" &&
      ...
      if (choice == "1" || choice == "2" || choice == "3" || choice == "4" ||
          choice == "5" || choice == "6") {
        if (items[static_cast<int> (choice[0]) - 49]->get_price () >
            this->gold) {
          ...
          if (this->check (items[static_cast<int> (choice[0]) - 49]->get_name ()
            ...
            this->add (
                items[static_cast<int> (choice[0]) - 49]->get_name (), 1
            );
          }
              ...
              std::cout
                  ...
                  << this->inventory[static_cast<int> (choice[0] - 49)]
                         ...
                         this->inventory[static_cast<int> (choice[0] - 49)]
                             ->get_quantity ()
                  << " golds" << std::endl;
              this->gold += this->inventory[static_cast<int> (choice[0] - 49)]
                                ->get_price () *
                            this->inventory[static_cast<int> (choice[0] - 49)]
                                ->get_quantity ();
              this->remove_elem (
