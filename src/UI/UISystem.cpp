...
void UISystem::display_rules() const
{
  std::cout << "============= RULES ==================" << std::endl;
	...
	std::cout << "    -> " << color(ColorType::GREEN) << "Green" << color(ColorType::DEFAULT) << " is " << color(ColorType::GREEN) << "Common" << color(ColorType::DEFAULT) << std::endl;
	std::cout << "    -> " << color(ColorType::BLUE) << "Blue" << color(ColorType::DEFAULT) << " is " << color(ColorType::BLUE) << "Rare" << color(ColorType::DEFAULT) << std::endl;
	std::cout << "    -> " << color(ColorType::RED) << "Purple" << color(ColorType::DEFAULT) << " is " << color(ColorType::RED) << "Epic" << color(ColorType::DEFAULT) << std::endl;
	std::cout << "    -> " << color(ColorType::YELLOW) << "Yellow" << color(ColorType::DEFAULT) << " is " << color(ColorType::YELLOW) << "Legendary" << color(ColorType::DEFAULT) << std::endl;
