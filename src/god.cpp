...
Item* generate_item()
{
	...
	std::vector<Item*> items = {
		new Common_Sword, new Rare_Sword, new Epic_Sword, new Legendary_Sword,
		new Common_Boots, new Rare_Boots, new Epic_Boots, new Legendary_Boots,
		new Common_Chestplate, new Rare_Chestplate, new Epic_Chestplate, new Legendary_Chestplate,
		new Common_Helmet, new Rare_Helmet, new Epic_Helmet, new Legendary_Helmet,
		new Common_Leggings, new Rare_Leggings, new Epic_Leggings, new Legendary_Leggings
	};
